  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-8 lg:p-12">
      <div className="max-w-4xl mx-auto p-6 sm:p-8 bg-white shadow-lg rounded-lg">
        <h1 className="text-2xl sm:text-3xl font-bold text-green-500 text-center mb-4 sm:mb-6">
          Terms and Conditions
        </h1>

        {/* General Section */}
        <div className="text-base sm:text-lg leading-relaxed text-gray-700">
          <h2 className="text-xl sm:text-2xl font-semibold text-green-500 mb-3">General:</h2>
